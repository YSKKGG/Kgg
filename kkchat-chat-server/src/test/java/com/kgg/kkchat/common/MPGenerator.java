...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/kkchat-chat-server/src/main/java");
        //设置作者名字
        globalConfig.setAuthor("kgg");
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://162.14.69.250:3306/kkchat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}